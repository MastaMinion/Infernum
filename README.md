...
|---|---|
| `rift_walker.mp3` | Unlocked by default |
...
The game runs without these files — the player will stay paused and show "No tracks in rotation" in the full playlist view.
